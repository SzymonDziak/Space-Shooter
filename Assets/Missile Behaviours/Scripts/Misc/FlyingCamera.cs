...
namespace MissileBehaviours.Misc
{
    ...
    public class FlyingCamera : MonoBehaviour
    {
        ...
        // Using the fixed update rather than the normal update to keep the camera in sync with missile movements.
        // In an actual game you'd want to use update and interpolate the missiles via their rigidbody component.
        void Update()
        {
            ...
            // Clamp the vertical rotation to avoid all the problems that can occur otherwise, such as flying upside down and breaking the way that rotation works.
