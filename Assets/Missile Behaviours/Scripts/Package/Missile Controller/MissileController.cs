...
namespace MissileBehaviours.Controller
{
    ...
    public class MissileController : MonoBehaviour
    {
        ...
        /// <summary>
        /// The time, in seconds, after which the gravity is toggled.
        /// </summary>
        public float GravityDelay
        {
            get { return gravityDelay; }
            set { gravityDelay = value; }
        }
        /// <summary>
        ...
        /// <summary>
        /// Gets the amount of seconds the missile has been alive for.
        /// </summary>
        ...
        void FixedUpdate()
        {
            ...
            if (gravityDelay != 0)
            {
                if (elapsedTime >= gravityDelay && !gravityToggled)
                {
